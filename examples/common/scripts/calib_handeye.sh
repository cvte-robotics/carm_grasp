...
# 相机内参文件路径
cam_param_path="${root_dir}/data/calib/cam_params.json"  

# 标定板信息: [tag_size( m ), space_size( m ), tag_rows, tag_cols]
calib_board_info='[0.0352, 0.01056, 6, 6]'  

# 图像目录
img_dir="/home/user/Work/Public/carm_grasp/results/auto_collect/calib_handeye/cam0" 

# 机械臂末端位姿文件路径
arm_pose_path="/home/user/Work/Public/carm_grasp/results/auto_collect/calib_handeye/arm_pose.json"  
